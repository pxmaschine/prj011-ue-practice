...
void UUPInteractionComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UUPInteractionComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
