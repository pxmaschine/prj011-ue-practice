...
AActor* UUPActorPoolingSubsystem::AquireFromPool(TSubclassOf<AActor> ActorClass, const FTransform& SpawnTransform,
...
AActor* UUPActorPoolingSubsystem::GetPooledActor(UObject* WorldContextObject, TSubclassOf<AActor> ActorClass,
